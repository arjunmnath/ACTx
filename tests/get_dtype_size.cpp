...
TEST(TensorDataType, Int8Size) {
  EXPECT_EQ(getDTypeSize(DType::int8), 1);
}
...
TEST(TensorDataType, Int16Size) {
  EXPECT_EQ(getDTypeSize(DType::int16), 2);
}
...
TEST(TensorDataType, Int32Size) {
  EXPECT_EQ(getDTypeSize(DType::int32), 4);
}
...
TEST(TensorDataType, Int64Size) {
  EXPECT_EQ(getDTypeSize(DType::int64), 8);
}
