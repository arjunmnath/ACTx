...
class TestReLUFunction(unittest.TestCase):
    ...
    def test_ReLU_positive_values(self):
        np.testing.assert_array_equal(self.activate(np.array([1, 2, 3])), np.array([1, 2, 3]))

    def test_ReLU_negative_values(self):
        np.testing.assert_array_equal(self.activate(np.array([-1, -2, -3])), np.array([0, 0, 0]))

    def test_ReLU_mixed_values(self):
        np.testing.assert_array_equal(self.activate(np.array([-1, 0, 1, 2])), np.array([0, 0, 1, 2]))

    def test_ReLU_zeros(self):
        np.testing.assert_array_equal(self.activate(np.array([0, 0, 0])), np.array([0, 0, 0]))
...
class TestSoftmaxFunction(unittest.TestCase):
    ...
    def test_softmax_standard_case(self):
        ...
        np.testing.assert_array_almost_equal(self.activate(input_array), expected_output, decimal=5)
...
class TestReluDerivative(unittest.TestCase):
    ...
    def test_relu_derivative_positive_values(self):
        np.testing.assert_array_equal(self.gradient(np.array([1, 2, 3])), np.array([1, 1, 1]))

    def test_relu_derivative_negative_values(self):
        np.testing.assert_array_equal(self.gradient(np.array([-1, -2, -3])), np.array([0, 0, 0]))

    def test_relu_derivative_mixed_values(self):
        np.testing.assert_array_equal(self.gradient(np.array([-1, 0, 1, 2])), np.array([0, 0, 1, 1]))

    def test_relu_derivative_zeros(self):
        np.testing.assert_array_equal(self.gradient(np.array([0, 0, 0])), np.array([0, 0, 0]))
...
class TestSoftmaxDerivative(unittest.TestCase):
    ...
    def test_basic_case(self):
        ...
        np.testing.assert_array_almost_equal(self.gradient(softmax_output), expected_jacobian, decimal=5)
